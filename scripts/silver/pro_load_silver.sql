...
BEGIN
	...
	BEGIN TRY
		...
		-- insert data into: silver.crm_dales_details
		PRINT '---------------------------------------';
		SET @start_time= GETDATE();
		PRINT('>> Truncating table: silver.crm_dales_details');
		TRUNCATE TABLE silver.crm_dales_details;
		PRINT('>> Inserting data into: silver.crm_dales_details');
		INSERT INTO silver.crm_dales_details(
		sls_ord_num,
		sls_prd_key,
		sls_cust_id,
		sls_order_dt, 
